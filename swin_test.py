...
if __name__ == '__main__':
    ...
    # parser.add_argument('--encoder_path', type=str, default='save_model_poshw/encoder4-1.ckpt',
    #                     help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='hssavemodel/swinpos/decoder1-1.ckpt',
