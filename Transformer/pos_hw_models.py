...
import numpy as np
import math
from S_T.Transformer.pos import PositionEmbeddingSineHW
...
class Encoder(nn.Module):
    ...
    def __init__(self, n_layers, d_k, d_v, d_model, d_ff, n_heads,
        ...
        self.pos=PositionEmbeddingSineHW(num_pos_feats=1024, temperatureH=10000, temperatureW=10000, normalize=False, scale=None)
