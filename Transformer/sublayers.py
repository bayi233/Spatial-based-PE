...
from S_T.Transformer.modules import ScaledDotProductAttention
from S_T.Transformer.modules import LayerNormalization
...
class PoswiseFeedForwardNet(nn.Module):
    def __init__(self, d_model, d_ff, dropout=0.1):
        ...
        self.relu = nn.ReLU()
        self.active=nn.GELU()                                                                  #######attention! activation here
        # self.active=nn.Mish()
    ...
    def forward(self, inputs):
        # inputs: [b_size x len_q x d_model]relu
        residual = inputs
