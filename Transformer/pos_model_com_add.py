...
import numpy as np
import math
from S_T.Transformer.pos_add_version import PositionEmbeddingSine
...
class Encoder(nn.Module):
    ...
    def __init__(self, n_layers, d_k, d_v, d_model, d_ff, n_heads,
        ...
        self.pos=PositionEmbeddingSine(num_pos_feats=2048, temperature=10000,  normalize=False, scale=None)
