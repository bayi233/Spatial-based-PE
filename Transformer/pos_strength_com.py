...
import numpy as np
import math
from S_T.Transformer.strengthpos import StrengthenSpatialPosEncodingcom
...
class Encoder(nn.Module):
    ...
    def __init__(self, n_layers, d_k, d_v, d_model, d_ff, n_heads,
        ...
        self.pos=StrengthenSpatialPosEncodingcom( num_pos_feats=2048, temperature=10000, normalize=False, scale=None)
