...
import numpy as np
import math
from S_T.Transformer.pos_add_version import LearnedPositionalEncoding
...
class Encoder(nn.Module):
    ...
    def __init__(self, n_layers, d_k, d_v, d_model, d_ff, n_heads,
        ...
        self.pos=LearnedPositionalEncoding(num_feats=2048, row_num_embed=12,col_num_embed=12)
