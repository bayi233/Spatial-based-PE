...
class Translator(object):
    ...
    def translate_batch(self, src_batch):
        ...
        # print(enc_outputs.shape)  #(batch*beam_size,lenth,features_siez)
        # Prepare beams  ##
        ...
        for i in range(self.opt.max_decode_step):
            ...
            # print(1,dec_partial_inputs)
            # print(2,dec_partial_inputs_len)
            # print(3,dec_partial_inputs.shape)
            # print(4,dec_partial_inputs_len.shape)
            # print(5,enc_inputs.shape)
            # print(6,enc_outputs.shape)
            # Decoding
            ...
            def update_active_seq(seq_var, active_inst_idxs):
                ...
                active_seq_data = original_seq_data.index_select(0, active_inst_idxs)           #error
            ...
            enc_inputs = update_active_seq(enc_inputs, active_inst_idxs)              ##  error
