...
# pos=LearnedPositionalEncoding(num_feats=1024, row_num_embed=14,col_num_embed=14,)
# batch=4
# picture=14
...
# test》LearnedPositionalEncoding
# pos=LearnedPositionalxy(num_feats=1024, embed=14)
# batch=4
# picture=14
# pos_out=pos(batch,picture,picture)
# print(pos_out.shape)
...
# #test》Poslearned
# pos=Poslearned(w=14,h=14,features=2048)
# pos_out=pos(batch=4)
# print(pos_out.shape)

# pos=PositionEmbeddingSineHW(num_pos_feats=1024, temperatureH=10000, temperatureW=10000, normalize=False, scale=None)
# batch=4
# picture=14
...
# pos=PositionEmbeddingSine(num_pos_feats=1024, temperature=10000, normalize=False, scale=None)
# batch=4
# picture=14
# pos_out=pos(batch,picture)
# print(pos_out.shape)
...
# # 隔八抽取forwar
# out = self.pos_embedding[:, 0, :].unsqueeze(1)
# for i in range(self.w):
#     for j in range(self.w*self.h):
#         if j%(self.w)==i:
#             if j!=0:
#                 out=torch.cat((out,self.pos_embedding[:,j,:].unsqueeze(1)),dim=1)
# out=out.repeat(batch,1,1)
# print(out)
# return  out
