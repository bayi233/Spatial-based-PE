...
def main(args):
    ...
    criterion = nn.CrossEntropyLoss(ignore_index=0)    ##best lr 0.000001
    decoder_optimizer = optim.Adam(decoder.parameters(), lr=0.0000005)  #1~7 lr=0.00003/  8,9:add w_d=0.5 / 10,11 lr=0.0000075 ,12,13 w_d=0.5  ##weight_decay=0.00000125
    ...
    for epoch in range(args.num_epochs):  ##时间步
        ...
        torch.save(decoder.state_dict(),
                   os.path.join(args.model_path, 'decoder-swin4-{}.ckpt'.format(epoch + 1)))
    ...
    picture_loss.savefig(r'loss_picture/loss_train_swin_2017_no2.png')
    plt.show()
    ...
    plt.legend(loc='best')
    picture_loss = plt.gcf()
    picture_loss.savefig(r'loss_picture/loss_eval_swin_2017_no2.png')
    plt.show()
...
if __name__ == '__main__':
    ...
    ##~~~initial
    parser.add_argument('--model_path', type=str, default='/media/huashuo/mydisk/hssavemodel/pool', help='path for saving trained models')
    ...
    parser.add_argument('--image_dir', type=str, default='/media/huashuo/mydisk/cocodataset/coco2017/images_resized384/train2017',    ##384_resized/train2014
                        help='directory for resized images')
    parser.add_argument('--caption_path', type=str,
                        default='/media/huashuo/mydisk/cocodataset/coco2017/annotations/captions_train2017.json',
    ...
    parser.add_argument('--image_dir_eval', type=str,
                        default='/media/huashuo/mydisk/cocodataset/coco2017/images_resized384/val2017',
                        ##images_resized
                        help='directory for resized images')  ##new

    # parser.add_argument('--caption_path_eval', type=str,
    #                     default='/media/huashuo/mydisk/cocodataset/coco2014/annotations_trainval2014/annotations/captions_val2014.json',
    #                     help='path for train annotation json file')  ###new
    # parser.add_argument('--image_dir_eval', type=str,
    #                     default='/media/huashuo/mydisk/cocodataset/coco2014/384_resized/val2014',  ##images_resized
    #                     help='directory for resized images')  ##new
    # parser.add_argument('--image_dir', type=str,
    #                     default='/media/huashuo/mydisk/cocodataset/coco2014/384_resized/train2014',
    #                     ##384_resized/train2014
    #                     help='directory for resized images')
    # parser.add_argument('--caption_path', type=str,
    ...
    parser.add_argument('--decoder', type=str, default='/media/huashuo/mydisk/hssavemodel/pool/decoder-swin2-4.ckpt',  # default.pkl
